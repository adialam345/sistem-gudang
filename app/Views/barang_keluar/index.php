...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg shadow-lg">
        <div class="px-6 py-8 sm:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Barang Keluar</h1>
                    <p class="mt-2 text-gray-900">Kelola transaksi barang keluar dengan mudah dan terstruktur</p>
                </div>
                <div class="hidden sm:block">
                    <svg class="w-24 h-24 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 3H4a2 2 0 00-2 2v14a2 2 0 002 2h16a2 2 0 002-2V5a2 2 0 00-2-2z"/>
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="px-4 sm:px-6 py-5">
            <form id="searchForm" action="<?= site_url('barang-keluar') ?>" method="get">
    ...
    <div class="bg-white rounded-lg shadow-lg">
        <div class="px-6 py-5 border-b border-gray-200">
            <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-900">Daftar Barang Keluar</h2>
                <div class="flex space-x-2">
                    <a href="<?= site_url('barang-keluar/export-excel') . '?' . http_build_query($_GET) ?>" 
                    ...
                    <a href="<?= site_url('barang-keluar/export-pdf') . '?' . http_build_query($_GET) ?>" 
                ...
                <table class="min-w-full divide-y divide-gray-200 table-responsive">
                    <thead class="bg-yellow-50">
                        <tr>
                            ...
                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-[12%]">Tujuan</th>
                        ...
                        <?php else : ?>
                            <?php foreach ($barangKeluar as $item) : ?>
                                <tr class="hover:bg-yellow-50">
                                    ...
                                    <td class="px-4 sm:px-6 py-4 text-sm text-gray-900" data-label="Tujuan">
                                        <?= esc($item['tujuan']) ?>
                                    </td>
