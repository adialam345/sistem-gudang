    ...
    <div class="bg-gradient-to-r from-warehouse-400 to-warehouse-500 rounded-lg shadow-lg">
        <div class="px-6 py-8 sm:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-white sm:text-3xl">Barang Masuk</h1>
                    <p class="mt-2 text-warehouse-100">Kelola transaksi barang masuk dengan mudah dan terstruktur</p>
                </div>
