                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="jumlah" id="jumlah" 
                                   value="<?= isset($barangMasuk) ? $barangMasuk['jumlah'] : old('jumlah') ?>"
                                   class="shadow-sm focus:ring-warehouse-500 focus:border-warehouse-500 block w-full sm:text-sm border-gray-300 rounded-md" 
                                   min="1" required>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="keterangan" name="keterangan" rows="3" 
                                      class="shadow-sm focus:ring-warehouse-500 focus:border-warehouse-500 block w-full sm:text-sm border-gray-300 rounded-md"><?= isset($barangMasuk) ? esc($barangMasuk['keterangan']) : old('keterangan') ?></textarea>
                        </div>
