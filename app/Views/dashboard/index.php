                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <div class="mt-1 flex items-baseline">
                            <div class="text-3xl font-semibold text-gray-900"><?= number_format($totalSKU) ?></div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <div class="mt-1 flex items-baseline">
                            <div class="text-3xl font-semibold text-gray-900"><?= number_format($totalStok) ?></div>
    ...
    <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <div class="mt-1 flex items-baseline">
                            <div class="text-3xl font-semibold text-gray-900"><?= number_format($masukHariIni) ?></div>
                            <div class="ml-2 text-sm font-medium text-gray-500">Unit</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <div class="mt-1 flex items-baseline">
                            <div class="text-3xl font-semibold text-gray-900"><?= number_format($keluarHariIni) ?></div>
                            <div class="ml-2 text-sm font-medium text-gray-500">Unit</div>
                        </div>
                    </div>
                </div>
